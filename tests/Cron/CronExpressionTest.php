...
class CronExpressionTest extends TestCase
{
	 ...
	 */
	public function testValidExpressionsPassValidation( $expression )
	{
	...
	{
		return require __DIR__ . '/Fixtures/ValidCrontabIntervals.php';
	}
	 ...
	 */
	public function testInvalidExpressionsFailValidation( $expression )
	{
		$this->assertTrue( CronExpression::isValidExpression( $expression ) );
	}
	...
	{
		return require __DIR__ . '/Fixtures/InvalidCrontabIntervals.php';
	}
}
